...
ActiveRecord::Schema.define(version: 2020_04_02_030352) do
  ...
  create_table "replies", force: :cascade do |t|
    ...
    t.index ["user_id", "conversation_id", "created_at"], name: "index_replies_on_user_id_and_conversation_id_and_created_at"
